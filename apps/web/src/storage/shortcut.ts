// src/storage/shortcuts.ts

import { DEFAULT_SHORTCUT_ACTIONS, STORAGE_KEYS } from "@/config/shortcut";
import type {
  ShortcutAction,
  ShortcutBinding,
  ShortcutConflict,
...
import { getPlatform } from "@/lib/types";
...
// Mock localStorage for Bun/Node environment testing
const localStorage = {
...
export const formatShortcutKeyForDisplay = (key: string): string => {
  return key
    ...
    .map((part) => {
      ...
      // Capitalize first letter and replace common acronyms
