    ...
    <div className="group flex items-center gap-x-3">
      <motion.div
        className="bg-background/70 rounded-full px-2 py-1 flex items-center gap-2
                   shadow-2xl border border-muted- w-fit flex-shrink-0"
      ...
      >
        <div>
          <Button
            ...
            className=" rounded-full px-4 h-7 gap-2 font-medium text-xs "
            style={{
        ...
        <div>
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 rounded-full hover:bg-[#4a4a4a] text-[#b0b0b0] hover:text-white"
        ...
        <div>
          <Button
            ...
            className="h-8 w-8 rounded-full hover:bg-[#4a4a4a] text-[#b0b0b0] hover:text-white cursor-grab"
          >
      ...
      >
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 rounded-full hover:bg-[#4a4a4a] text-white group"
          // onClick={}
        >
          <X
